...
class TurtleBot4Test(Node):
    ...
    def map_callback(self, msg):
        ...
        self.get_logger().info('Map data has been received.')
    ...
    def feedback_callback(self, feedback_msg):
        ...
        #self.get_logger().info(f'Recevied feedback: distance remaining = {feedback.distance_remaining}')
